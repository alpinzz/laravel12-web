                    ...
                    @forelse ($blogs as $blog)
                        <div class="lonyo-blog-wrap aos-init aos-animate" data-aos="fade-up" data-aos-duration="500">
                            ...
                            <div class="lonyo-blog-meta">
                                <ul>
                                    <li>
                                        <a href="single-blog.html"><img src="assets/images/blog/date.svg"
                            ...
                            <div class="lonyo-blog-btn">
                                <a href="{{ route('single.blog', $blog->slug) }}"
                                    class="lonyo-default-btn blog-btn">continue
                                    reading</a>
                            </div>
                        </div>
                    @empty
                        ...
                        <div class="lonyo-blog-widgets">
                            ...
                            <div class="lonyo-blog-categorie">
                                @foreach ($categories as $category)
                                    <ul>
                                        <li><a
                                                href="single-blog.html">{{ $category->name }}<span>{{ $category->blogs_count }}</span></a>
                                        </li>
                            ...
                            @foreach ($recentBlogs as $recent)
                                <a class="lonyo-blog-recent-post-item" href="single-blog.html">
                                    ...
                                    <div class="lonyo-blog-recent-post-data">
                                        <ul>
                                            <li><img src="assets/images/blog/date.svg"
                                                    alt="">{{ $recent->created_at->format('F d, Y') }}</li>
                                        </ul>
                                        <div>
